<script setup></script>
<template>
  <footer class="w-full flex flex-col gap-10 p-10 bg-neutral text-base-content">
    <div class="footer bg-neutral text-base-content">
      <aside class="text-3xl">
    ...
    <div class="footer bg-neutral text-base-content items-center">
